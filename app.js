...
var logger = log4js.getLogger('HyperledgerWebApp');
...
// set secret variable
app.set('secret', 'wadhotgfxgmbvsegdswtilnbczaej');
app.use(expressJWT({
	secret: 'wadhotgfxgmbvsegdswtilnbczaej'
}).unless({
	path: ['/users']
}));
app.use(bearerToken());
...
app.put('/channels/:channelName/chaincodes', function(req, res) {
...
app.post('/query/channels/:channelName/chaincodes/:chaincodeName', function(req, res) {
